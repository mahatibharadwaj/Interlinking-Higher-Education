...
$result=mysql_query("SELECT * FROM `coursecontent` WHERE scope='$scope' AND type='$type'".$_SESSION['coursecontent']);
...
<td align="center" bgcolor="#FFFFFF"><a href="download">Download</a><?php echo $rows['content']; ?></td>
